                    ...
                    <Card className="bg-blue-400 rounded-lg w-full h-1/3">
                        <CardContent className="flex flex-row rounded-lg w-full h-full">
                            ...
                            <div className="flex items-center justify-center w-1/3">
                                {/* <Image src="https://pixabay.com/photos/cat-animals-fun-domestic-cat-4227330/" className="border border-black rounded-full" /> */}
                                <img 
                                    src="https://pixabay.com/photos/cat-animals-fun-domestic-cat-4227330/"
                                    alt="profile icon"
